...
<head>
    ...
    <!-- Favicon-->
    <link rel="shortcut icon" href="{{asset('/education')}}/fav.png">
    <!-- Author Meta -->
              ...
              <div class="container">
                  <div class="row">
                      ...
                      <div class="col-lg-6 col-sm-6 col-4 header-top-right no-padding">
                          <a href="tel:+953 012 3654 896"><span class="lnr lnr-phone-handset"></span> <span class="text">{{config('sekolah.telepon')}}6</span></a>
