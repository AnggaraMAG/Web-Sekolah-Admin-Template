			...
			<div class="vertical-align-middle">
				<div class="auth-box ">
					<div class="left">
						<div class="content">
							<div class="header">
								<div class="logo text-center"><img src="{{asset('admin/assets/{{asset('/education')}}/logo-dark.png')}}" alt="Klorofil Logo"></div>
					...
					<div class="right">
						...
						<div class="content text">
							<h1 class="heading">App Pengelolah Data Siswa</h1>
							<p>by AnggaraMAG</p>
						</div>
					</div>
